...
function Page() {
      ...
      <div className="w-full max-w-6xl px-4 pt-24 sm:pt-32 pb-20">
        ...
        >
          <div className="space-y-8 order-2 md:order-1">
            ...
            <div className="text-lg max-w-lg" style={{ color: "#EDEDED" }}>
              <BlurText
                text="Computer Engineering Graduate & Full-Stack Developer with strong expertise in MERN Stack and Next.js, skilled in building end-to-end web solutions from frontend interfaces to backend APIs."
                delay={150}
                animateBy="words"
                direction="top"
                ...
                {socialLinks.map((link) => {
                  ...
                  return (
                    <a
                      ...
                      className="p-3 hover:text-indigo-400 hover:bg-gray-800 rounded-full transition-all duration-200"
                      style={{ color: "#EDEDED" }}
                    >
        ...
        >
          <div className="container mx-auto px-4 max-w-6xl">
            <div className="text-center mb-16">
              <h2
                className="text-xl sm:text-2xl font-bold tracking-[0.3em] uppercase"
                style={{ color: "#EDEDED" }}
              >
                <ShinyText
                  text="Technologies"
              ...
              <div
                className="w-12 h-[2px] mx-auto mt-4 rounded-full opacity-20"
                style={{ background: "#EDEDED" }}
              ></div>
            </div>

            {/* INTEGRATED LOGOLOOP HERE */}
 ...
 <section id="projects" className="w-full py-16 sm:py-24" style={{ background: "#171717" }}>
          <div className="container mx-auto px-4 max-w-6xl">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              {projectsData.map((project, index) => (
                <SpotlightCard
                  key={project.title}
                  className="custom-spotlight-card transition-all duration-500 hover:-translate-y-2"
                  spotlightColor="rgba(245, 245, 220, 0.15)"
                >
                  <div className="p-6 sm:p-8 h-full flex flex-col">
                    ...
                    <p className="mb-6 text-sm leading-relaxed flex-grow" style={{ color: "#A3A3A3" }}>
                      {project.description}
                    </p>
                    ...
                    <div className="flex items-center justify-between pt-6 border-t border-white/5">
                      ...
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                       className="group/btn relative inline-flex items-center gap-2 px-5 py-2 overflow-hidden rounded-lg bg-[#F5F5DC] text-[#171717] transition-all hover:pr-8"
                      >
      ...
      <footer
        className="w-full border-t border-white/5 py-8"
        style={{ background: "#171717" }}
      >
